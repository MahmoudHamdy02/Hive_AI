...
def start_game(game_parameters: GameParameters):
    ...
    if game_parameters.selected_mode == Gamemode.PvP:
        ...
        name1 = game_parameters.name1
        agent2 = IterativeDeepeningAgent(controller,Color.Black ,  game_parameters.difficulty1,400)

    elif game_parameters.selected_mode == Gamemode.CvC:
        agent1 = IterativeDeepeningAgent(controller,Color.White , game_parameters.difficulty1, 400)
        agent2 = IterativeDeepeningAgent(controller,Color.Black , game_parameters.difficulty2,400)
